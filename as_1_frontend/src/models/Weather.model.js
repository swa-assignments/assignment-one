import { FORECAST_TYPE } from "../utils/constants";

// Helper function to format the data from the API using factory functions
export const Weather = function (data = []) {
  // Data validation - if the data is not an array, throw an error
